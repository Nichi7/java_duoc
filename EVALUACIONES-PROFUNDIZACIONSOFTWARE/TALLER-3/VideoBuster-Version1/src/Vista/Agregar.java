...
public class Agregar extends javax.swing.JFrame {
    ...
    public Agregar() {
        ...
        for (Categoria c : r.getCategoria()) {
            cbxcategoria.addItem(c); //se agrega al combobox los datos obtenidos desde el arreglo categ
        }
    }
    ...
    private void verifica1(javax.swing.JTextField t) {
        ...
        if (teclado.length() > 0) {
            ...
            /*if (!Character.isLetter(tecla)) {
                t.setText(teclado);
                JOptionPane.showMessageDialog(this, "El nombre de la película solo acepta letras del alfabeto español");
                return;
            }*/
            /*if(tecla == ' '){
               JOptionPane.showMessageDialog(this, "El nombre de la película no puede empezar por espacio"); 
            }*/
        }
