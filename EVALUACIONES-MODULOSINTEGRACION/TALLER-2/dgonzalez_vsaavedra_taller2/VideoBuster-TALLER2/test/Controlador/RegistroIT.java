...
public class RegistroIT {
    ...
    public void testbuscar2() throws Exception {
        System.out.println("Comienza testeo buscar una pelicula cuya categoria tenga un texto determinado");
        Categoria instance = new Categoria();
        Registro r = new Registro();
        instance.setDescrip("Accion");
        r.buscar2(instance.getDescrip());
        System.out.println("Teste realizado correctamente");
    ...
    public void testActualizar2() throws Exception {
        System.out.println("Comienza testeo actualizar categoria de la pelicula");
        Pelicula instance = new Pelicula();
        Registro r = new Registro();
        instance.setCodigo(70000);
        r.buscar(instance.getCodigo());
        instance.setCategoria(4);
        r.actualizar2(instance);
        System.out.println("Teste realizado correctamente");
    }
